...
poetry run python scripts/s3_ec2_embedding_pipeline.py --num_pages_to_process 1 --bucket_name 'bcgl-public-bucket' --pdf_dir 'archive/2020/PDFs/' --data_dir $data_dir
