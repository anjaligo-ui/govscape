...
poetry run python scripts/python_helpers/generate_index_keyword.py --num_pages_to_process 1000000 --bucket_name 'bcgl-public-bucket' --in_data_dir $data_dir --out_data_dir $data_dir 
